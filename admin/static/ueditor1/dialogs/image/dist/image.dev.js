...
(function () {
  ...
  RemoteImage.prototype = {
    ...
    updateLocker: function updateLocker() {
    ...
    getInsertList: function getInsertList() {
  ...
  OnlineImage.prototype = {
    ...
    /* 添加图片到列表界面上 */
    pushData: function pushData(list) {
      var i,
          item,
          img,
          icon,
    ...
    /* 改变图片大小 */
    scale: function scale(img, w, h, type) {
      var ow = img.width,
          oh = img.height;
  ...
  SearchImage.prototype = {
    ...
    encodeToGb2312: function encodeToGb2312(str) {
      if (!str) return '';
      var strOut = "",
