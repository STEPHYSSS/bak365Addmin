    ...
    >
      ...
      >
        ...
        <el-table-column prop="Stock" label="活动商品数量">
          <template slot-scope="scoped">
            <!-- <el-input style="width:80px" v-model="scoped.row.Stock"></el-input> -->
...
export default {
  ...
  data() {
    return {
      dialogVisible: false,
      dialogVisibleSpecs: false,
      loadingGoodsSpecs: false,
      loadingGoods: true,
      goodsNameList: [],
      goodsSpecsList: [],
      currentRow: {},
    ...
    async getList() {
      try {
        ...
        let { Data } = await getLists(
          { Action: "GetProdInfoList", Name: this.search.Name },
          "MProdOpera"
        );
