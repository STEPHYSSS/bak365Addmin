    ...
    <div class="loginGuard">
      <el-form :model="loginForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="" prop="PassWord">
          <el-input v-model="loginForm.PassWord" placeholder="请输入密码" @keyup.enter.native="login"
                    type="password"
                    width="250px"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button class="btnStyle" type="blue" @click="login" style="margin-top:20px" :loading="loading">登录
          </el-button>
        </el-form-item>
        <div style="color:#fff;position:absolute;bottom:-25px;right:0">Copyright {{new Date().getFullYear()}}-{{new
