<template>
  <div class="commissionDetail">
    ...
    <fieldset class="Leader">
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <span>名称：{{tablObj2.Name}}</span>
        </el-col>
        <el-col :span="8">
          <span>微卡卡号：{{tablObj2.CardNo}}</span>
        </el-col>
        <el-col :span="8">
          <span>支付宝账号：{{tablObj2.AlipayAccount}}</span>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="8">
          <span>微信账号：{{tablObj2.WeChatAccount}}</span>
        </el-col>
        <el-col :span="8">
          <span>手机号：{{tablObj2.Mobile}}</span>
        </el-col>
        <el-col :span="8">
          <span>审核状态：{{tablObj2.Audit | checkTip}}</span>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="8">
          <span>分享码：{{tablObj2.ShareCode}}</span>
        </el-col>
      </el-row>
    </fieldset>
    <!-- 打款信息 -->
    <div class="RemitBox">
      <fieldset class="Leader">
        ...
        <span>打  款：</span>
        <el-button @click="paymentInfo(tablObj2.CardNo,'1')">微卡卡号</el-button>
        <el-button @click="paymentInfo(tablObj2.WeChatAccount,'2')">微信</el-button>
        <el-button @click="paymentInfo(tablObj2.AlipayAccount,'3')">支付宝</el-button>
        <div v-show="hideRemit" class="info">
          <el-row :gutter="20">
            <el-col :span="8">
              <span>账 号：{{remitObj.Account}}</span>
            </el-col>
            <el-col :span="8">
              <span>会员返佣编号：{{remitObj.RebateSID}}</span>
            </el-col>
            <el-col :span="8">
              <span>汇款流水单号：{{remitObj.RebateSID}}</span>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="8">
              <span>汇款金额：{{remitObj.PO}}</span>
            </el-col>
            <el-col :span="8">
              <span>
                汇款截图：
                <img :src="remitObj.Img" alt />
              </span>
            </el-col>
            <el-col :span="8">
              <span>备注：{{remitObj.Remarks}}</span>
            </el-col>
          </el-row>
        </div>
      </fieldset>
