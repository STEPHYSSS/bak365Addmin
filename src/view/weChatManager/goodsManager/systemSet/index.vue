<template>
  <div class="systemSet">
    ...
    <el-form ref="form" :model="form" label-width="200px" :rules="rules">
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="送货日期(用户取货)">
            <el-input-number v-model="form.ScopeDay" @change="handleChange" :min="1" :max="30"></el-input-number>
            <span style="color:#999">从当前日期开始，可预约多少天配送(自取)</span>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="是否可退款">
            <el-select v-model="form.IsRefund" placeholder="请选择">
              <el-option v-for="item in optionsRetreat" :label="item.label" :value="item.value" :key="item.value"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="佣金比例">
            <el-input v-model="form.Ratio" placeholder="推广订单金额 * 提现比例 =实际返佣金额"></el-input>
            <span style="color:#999">推广订单金额 * 提现比例 =实际返佣金额</span>
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <!-- <el-form-item label="送货日期(用户取货)">
        <el-input-number v-model="form.ScopeDay" @change="handleChange" :min="1" :max="30"></el-input-number>
        <div style="color:#999">从当前日期开始，可预约多少天配送(自取)</div>
      </el-form-item>
      <el-form-item label="营业时间段(取货,送货)">
        <el-time-picker
          is-range
...
<style scoped>
.el-range-editor.el-input__inner,.el-select,.el-input{
  width: 300px;
}
</style>
