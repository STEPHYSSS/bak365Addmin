          ...
          <el-form ref="form" label-width="50px">
            ...
            <el-form-item label="图片:">
              <div class="box-card-img">
                ...
                <!-- <img
                  src="https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1576720953&di=ff8ca8e9b9086b664d4c4cf10a3bd106&src=http://www.krabiview.com/wp-content/uploads/2015/04/tub-island-krabi-attraction-1.jpg"
                />-->
              </div>
            </el-form-item>
            <el-form-item label="编号:">{{item.ProdNo}}</el-form-item>
            <el-form-item label="口味:" v-if="item.TastName">{{item.TastName}}</el-form-item>
    ...
    <div class="info-style">
      ...
      <el-card class="box-card">
        <el-form ref="form" label-width="100px">
          ...
          <el-form-item
            label="退款状态:"
            v-if="OrderInfo.RefundState!=='1'"
          >{{OrderInfo.RefundState |refundStateList}}</el-form-item>
          <el-form-item
            label="退款类型:"
            v-if="OrderInfo.RefundState!=='1'"
          >{{Refund.Type}}</el-form-item>
          <el-form-item
            label="退款原因:"
            v-if="OrderInfo.RefundState!=='1'"
          >{{Refund.UserRemark}}</el-form-item>
          <el-form-item
            label="驳回原因:"
            v-if="OrderInfo.RefundState!=='1'&&Refund.Reply"
          >{{Refund.Reply}}</el-form-item>
          ...
          <el-form-item label="用户选择提货\配送的时间:" v-if="OrderInfo.PickTime">¥{{OrderInfo.PickTime}}</el-form-item>
    ...
    async getInfo() {
      try {
        let { Data } = await getLists(
          { Action: "GetOrderInfo", SID: this.$route.query.SID },
          "MOrderOpera"
        );
