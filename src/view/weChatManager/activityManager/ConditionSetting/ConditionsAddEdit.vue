<template>
  <div class="conditionsAddEdit">
    <el-form ref="form" :model="form" label-width="80px">
      ...
      <el-form-item label="订单笔数" prop="OrderCnt">
        <el-input v-model="form.OrderCnt"></el-input>笔
      </el-form-item>
      <el-form-item label="订单总额" prop="OrderAmt">
        <el-input v-model="form.OrderAmt"></el-input>元
      </el-form-item>
      <el-form-item label="最近" prop="OrderBuyDay">
        <el-input v-model="form.OrderBuyDay"></el-input>天购买过
      </el-form-item>
      <el-form-item label="最近" prop="NotOrderBuyDay">
        <el-input v-model="form.NotOrderBuyDay"></el-input>天未购买过
      </el-form-item>
      <el-form-item label="充值笔数" prop="CardOrderCnt">
        <el-input v-model="form.CardOrderCnt"></el-input>笔
      </el-form-item>
      <el-form-item label="充值金额" prop="CardOrderAmt">
        <el-input v-model="form.CardOrderAmt"></el-input>元
      </el-form-item>
      <el-form-item label="最近" prop="CardDay">
        <el-input v-model="form.CardDay"></el-input>天访问
      </el-form-item>
      <el-form-item label="最近" prop="NotCardDay">
        <el-input v-model="form.NotCardDay"></el-input>天未访问
      </el-form-item>
      ...
      <el-form-item label="年龄">
        <el-input v-model="form.StartAge"></el-input> 至
        <el-input v-model="form.EndAge"></el-input>
      </el-form-item>
      <el-form-item label="最近" prop="LatelyBirthday">
        <el-input v-model="form.LatelyBirthday"></el-input>天生日
      </el-form-item>
    </el-form>
  ...
  methods: {
     async getconditionInfo(){
          if(this.$route.query.SID){
               ...
               this.BirthdayTime[0] = this.form.StartBirthday;
               this.BirthdayTime[1] = this.form.EndBirthday;
